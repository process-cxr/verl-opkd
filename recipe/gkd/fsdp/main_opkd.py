...
# from rl_dataset import MixedThinkingRLHFDataset
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            from fsdp_workers import OPKDWorker, AsyncOPKDWorker
            ...
            from verl.workers.megatron_workers import OPKDWorker, AsyncOPKDWorker
    ...
    def run(self, config):
        ...
        # thinking_ratio = config.data.get("thinking_ratio", 0)
