...
STUDENT_MODEL_PATH=/home/work/cxr/models/Qwen3-4B
TEACHER_MODEL_PATH=/home/work/cxr/models/Qwen3-32B
# TEACHER_MODEL_PATH=/home/work/cxr/models/DeepSeek-V2-Lite-Chat


SAVE_CKPT_PATH=/home/work/cxr/qwen3_4B_kl_exp2
train_files=/home/work/cxr/datasets/100k_general7_mathcode3.parquet
test_files=/home/work/cxr/datasets/100k_general7_mathcode3.parquet
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    +actor_rollout_ref.actor.power_alpha=2.0 \
    ...
    +trainer.wandb_proxy='http://10.251.113.32:3128' \
    trainer.project_name='OPKD' \
    trainer.experiment_name="qwen3_4B_kl_exp2_$(now)" \
